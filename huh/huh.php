...
class WP_Huh {
	...
	public function display_huh() {
		...
		?>
		<script type="text/javascript">var huhDocUrl = '<?php echo $this->markdown_doc_url; ?>';</script>
		...
		<div class="huh-container" id="huh-container">
			<div class="huh-container--head" id="huh-header">
				...
				<svg class="huh-container--close-mobile" id="huh-mobile-close" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g id="plus"><path d="M18.36,19.78L12,13.41,5.64,19.78,4.22,18.36,10.59,12,4.22,5.64,5.64,4.22,12,10.59l6.36-6.36,1.41,1.41L13.41,12l6.36,6.36Z"/></g></svg>
			</div>
